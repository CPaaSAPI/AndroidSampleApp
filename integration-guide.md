...
You can find our sample application on [github](https://github.com/CPaaSAPI/AndroidSampleApp).  
This sample code demonstrate how to integrate the CPaaSAPI SDK to a kotlin application
...
TODO write here about dependency kotlin and permission after DEMOAPP
